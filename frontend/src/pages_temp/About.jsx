    ...
    <div data-testid="about-page">
      ...
      <section className="relative kg-section">
        ...
        <div className="max-w-[1200px] mx-auto relative">
          ...
          <p className="mt-6 text-zinc-600 dark:text-zinc-400 max-w-2xl leading-relaxed text-lg">
            ...
            {[
              ...
              return (
                <div key={v.t} className="kg-card p-7">
                  ...
                  <p className="text-zinc-600 dark:text-zinc-400 text-sm mt-2 leading-relaxed">{v.d}</p>
                </div>
              );
            })}
          </div>
      ...
      <section className="kg-section bg-surface-darker border-y border-zinc-100 dark:border-zinc-900">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/become-a-dealer" data-testid="about-become-dealer" className="bg-lime-500 hover:bg-lime-400 text-black dark:text-black font-bold px-7 py-4 rounded-md inline-flex items-center gap-2">
              Become a Dealer <ArrowRight className="h-4 w-4" />
            </Link>
            <Link href="/contact" data-testid="about-contact" className="border border-zinc-300 dark:border-zinc-700 hover:border-lime-500 hover:text-lime-500 px-7 py-4 font-bold rounded-md">
              Contact Sales
            </Link>
          </div>
        </div>
