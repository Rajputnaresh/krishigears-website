        ...
        <div className="flex flex-col md:flex-row gap-4 mb-10">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-zinc-900/80 border border-zinc-800 rounded-xl text-sm text-white placeholder:text-zinc-500 focus:outline-none focus:border-lime-500 transition"
            />
          </div>
                ...
                {cities.map((item) => (
                  ...
                  >
                    <div className="text-sm font-semibold text-zinc-200 group-hover:text-white mb-2 flex items-center justify-between">
                      {item.city}
                      <ChevronRight className="w-3.5 h-3.5 text-zinc-600 group-hover:text-lime-400 transition transform group-hover:translate-x-0.5" />
                    </div>
