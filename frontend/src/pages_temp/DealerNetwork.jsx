      ...
      <section className="relative kg-section overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto relative grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="mt-6 text-zinc-600 dark:text-zinc-400 text-lg max-w-xl leading-relaxed">
            ...
            <div className="mt-8 flex gap-3">
              ...
              <Link href="/contact" data-testid="dn-contact" className="border border-zinc-300 dark:border-zinc-700 hover:border-lime-500 hover:text-lime-500 px-7 py-4 font-bold rounded-md">Find Local Dealer</Link>
            </div>
          </div>
            ...
            {REGIONS.map((r) => (
              <div key={r.name} className="kg-card p-7">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {r.states.map((s) => (
                    <span key={s} className="text-xs px-3 py-1 border border-zinc-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400">{s}</span>
                  ))}
                </div>
              </div>
            ))}
