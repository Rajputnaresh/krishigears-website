...
export default function Warranty() {
  return (
    <div data-testid="warranty-page">
      ...
      <section className="kg-section bg-surface-darker border-y border-zinc-900 -mt-8">
        <div className="max-w-[1200px] mx-auto">
      ...
      <section className="kg-section">
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="mt-12 border border-lime-500/30 bg-lime-500/5 p-8 text-center">
            ...
            <p className="text-zinc-300 mt-2">Share your invoice number and we'll get back within 24 hours.</p>
...
function RegisterWarrantySection() {
  ...
  if (success) {
    return (
      <section data-testid="warranty-register-success" className="kg-section bg-surface-darker border-t border-zinc-900">
        <div className="max-w-2xl mx-auto text-center border border-lime-500/30 bg-lime-500/5 p-12">
          ...
          <p className="text-zinc-300 mt-4">Your product is now on our records. Keep your invoice safe — for any service request, just WhatsApp us at <strong className="text-lime-500">{COMPANY.phone}</strong>.</p>
        </div>
      </section>
    );
  }
  ...
  return (
    <section data-testid="warranty-register-section" className="kg-section bg-surface-darker border-t border-zinc-900">
      <div className="max-w-[1100px] mx-auto">
        ...
        <form onSubmit={submit} className="mt-10 border border-zinc-800 bg-surface-dark p-6 md:p-10 space-y-5">
          ...
          <div>
            <Label className="text-xs uppercase tracking-wider text-zinc-300">Additional notes (optional)</Label>
