...
export default function AdminLogin() {
  ...
  return (
    <div data-testid="admin-login-page" className="min-h-screen grid place-items-center bg-black p-6">
      <div className="w-full max-w-md border border-zinc-800 bg-surface-dark p-8 md:p-10">
        ...
        <p className="text-zinc-400 text-sm mt-2">Access leads, dealer applications and blog posts.</p>
        <form onSubmit={submit} className="mt-8 space-y-4">
          ...
          <div>
            <Label className="text-xs uppercase tracking-wider text-zinc-300">Password</Label>
            <Input
        ...
        <div className="mt-6 text-xs text-zinc-300 flex items-center gap-2">
