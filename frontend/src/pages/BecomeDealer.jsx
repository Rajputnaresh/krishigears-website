    ...
    return (
      <div data-testid="dealer-success-page" className="kg-section">
        <div className="max-w-2xl mx-auto text-center border border-lime-500/30 bg-lime-500/5 p-12">
          ...
          <p className="text-zinc-400 mt-4">Thank you for your interest in becoming a KrishiGears authorized dealer. Our dealer development team will review your application and contact you within <strong className="text-lime-500">48 working hours</strong>.</p>
    ...
    <div data-testid="become-dealer-page" className="kg-section">
      <div className="max-w-[1400px] mx-auto grid lg:grid-cols-12 gap-12">
        ...
        <form onSubmit={submit} className="lg:col-span-7 border border-zinc-800 bg-[#0F0F0F] p-6 md:p-10 space-y-5">
          ...
          <p className="text-zinc-500 text-sm">Please share accurate details. All fields marked with * are required.</p>
          ...
          <div>
            <Label className="text-xs uppercase tracking-wider text-zinc-400">Additional Information</Label>
