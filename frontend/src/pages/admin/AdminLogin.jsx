...
export default function AdminLogin() {
  ...
  return (
    <div data-testid="admin-login-page" className="min-h-screen grid place-items-center bg-black p-6">
      <div className="w-full max-w-md border border-zinc-800 bg-[#0F0F0F] p-8 md:p-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[10px] tracking-[0.25em] text-zinc-500 uppercase">Admin Console</div>
          </div>
        </div>
        <h1 className="font-display font-bold text-2xl mt-8">Sign in to manage</h1>
        <p className="text-zinc-500 text-sm mt-2">Access leads, dealer applications and blog posts.</p>
        <form onSubmit={submit} className="mt-8 space-y-4">
          ...
          <button
            ...
            className="w-full bg-lime-500 hover:bg-lime-400 text-black font-bold py-3.5 rounded-md transition inline-flex items-center justify-center gap-2 disabled:opacity-50"
          >
