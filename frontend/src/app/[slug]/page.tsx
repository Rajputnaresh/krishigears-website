      ...
      <section className="kg-section bg-surface">
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="kg-card p-6 rounded-lg">
                ...
                <p className="text-zinc-400 text-sm">{subsidyData.details}</p>
              </div>
              <div className="kg-card p-6 rounded-lg">
                <div className="w-12 h-12 bg-lime-500/10 rounded-full flex items-center justify-center mb-4">
                ...
                <p className="text-zinc-400 text-sm">Our authorized dealers in {locationName} will provide the necessary quotations and test reports required for your subsidy application.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-lime-500 text-black p-10 rounded-xl shadow-lg shadow-lime-500/20 text-center">
            <h2 className="kg-h3 mb-4">Become the Exclusive Dealer in {locationName}</h2>
            <p className="text-lime-900 mb-8 max-w-2xl mx-auto">
            ...
            <button className="bg-black text-lime-500 px-8 py-3 rounded-md font-bold hover:bg-zinc-900 transition-colors">
