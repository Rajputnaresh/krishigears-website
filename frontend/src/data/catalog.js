...
const FARMINGTOOLS_PRODUCT_HANDLES = {
  ...
  "kg-170f": "royal-kissan-nb-icp-c170-lce",
  "kg-173f-diesel": "royal-kissan-kg-173f",
  "kg-177f-wolf": "royal-kissan-kg-170f",
  "kg-baby-weeder": "royal-kissan-kg-bw-p63",
  "kg-bc-p50": "royal-kissan-kg-bc-p50-sp",
  "kg-bc-up35": "royal-kissan-kg-bc-up35-bp-sp",
  "kg-bc-up43": "royal-kissan-kg-bc-up43-sp",
  "kg-bc-up52": "royal-kissan-kg-bc-up52-sp-bp",
  "kg-chaff-cutter": "royal-kissan-kg-cc-3-2",
  "kg-csp-up58": "royal-kissan-kg-csp-up58-18-22",
  "kg-csp-up63": "royal-kissan-kg-csp-up63-18-22",
  "kg-ea-p52": "royal-kissan-kg-ea-p52",
  "kg-ea-p68": "royal-kissan-kg-ea-p68",
  "kg-icd-up186-sh": "royal-kissan-kg-icd-up186-sh",
  "kg-icp-p170-lde": "royal-kissan-kg-icp-p170-lde",
  "kg-icp-p177-lde": "royal-kissan-kg-icp-p177-lde",
  "kg-icp-up170-sh": "royal-kissan-kg-icp-up170-sh-ultra-premium",
  "kg-pw-wp-d80": "royal-kissan-kg-pw-wp-d80",
  "kg-pw-wp-p80": "royal-kissan-kg-pw-wp-p80",
  "kg-su80": "royal-kissan-kg-su80",
  "kg-wp-p02": "royal-kissan-kg-wp-p02",
  "kg-wp-p03": "royal-kissan-kg-wp-p03",
  "kg-wp-p1-5": "royal-kissan-kg-wp-p1-5",
  "kg-wp-up3": "royal-kissan-kg-wp-up3",
...
export const PRODUCTS = [
  {
    slug: "kg-170f", category: "power-weeders",
    name: "KG-170F Petrol Power Weeder (7 HP)",
    model: "KG-170F", badges: ["Bestseller", "FMTTI Tested"],
    images: [COVER.weeder],
  ...
  {
    slug: "kg-173f-diesel", category: "power-weeders",
    name: "KG-173F Diesel Power Weeder (5.5 HP)",
    model: "KG-173F", badges: ["High Torque"],
    images: [COVER.weeder],
  ...
  {
    slug: "kg-177f-wolf", category: "power-weeders",
    name: "KG-177F WOLF Petrol Weeder (9 HP)",
    model: "KG-177F", badges: ["Heavy Duty"],
    images: [COVER.weeder],
  ...
  {
    slug: "kg-icp-p170-lde", category: "power-weeders",
    name: "KG-ICP-P170-LDE Electric Start Weeder",
    model: "KG-ICP-P170-LDE", badges: ["Premium", "Self Start"],
    images: [COVER.weeder],
  ...
  {
    slug: "kg-icp-up170-sh", category: "power-weeders",
    name: "KG-ICP-UP170-SH Back-Rotary Weeder",
    model: "KG-ICP-UP170-SH", badges: ["Back Rotary"],
    images: [COVER.weeder],
  ...
  {
    slug: "kg-icd-up186-sh", category: "power-weeders",
    name: "KG-ICD-UP186-SH Diesel (10 HP)",
    model: "KG-ICD-UP186-SH", badges: ["Professional", "10 HP"],
    images: [COVER.weeder],
  ...
  {
    slug: "kg-baby-weeder", category: "power-weeders",
    name: "KG Baby Weeder (Lightweight)",
    model: "KG-BW", badges: ["Compact"],
  ...
  {
    slug: "kg-crankshaft", category: "power-weeder-spare-parts",
    name: "Crankshaft Assembly (7 HP / 9 HP)",
    model: "KG-CRANK-WEEDER", badges: ["Spare Part"],
    images: [COVER.crankshaft],
    specs: { Type: "Crankshaft", Grade: "OEM", Compatibility: "KG-170F, KG-177F" },
  ...
  {
    slug: "kg-piston-ring", category: "power-weeder-spare-parts",
    name: "Piston & Ring Set (Standard & Oversize)",
    model: "KG-PISTON-WEEDER", badges: ["Spare Part"],
    images: [COVER.piston],
  ...
  {
    slug: "kg-recoil-starter", category: "power-weeder-spare-parts",
    name: "Recoil Starter Assembly (Pull Cord)",
    model: "KG-RECOIL-WEEDER", badges: ["Spare Part"],
    images: [COVER.recoil],
    specs: { Type: "Recoil Starter Assembly", Compatibility: "KG-170F, KG-173F" },
  ...
  {
    slug: "kg-rotary-blades", category: "power-weeder-spare-parts",
    name: "Dryland / Wetland Tiller Blades (Set of 32)",
    model: "KG-BLADES-32", badges: ["Fast Moving Spare"],
    images: [COVER.weeder],
