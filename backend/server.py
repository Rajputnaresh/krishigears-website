...
@api_router.get("/admin/seed-rich-blogs")
async def seed_rich_blogs():
    ...
    for post in BLOG_POSTS:
        result = await db.blog_posts.update_one(
            ...
            {"$set": {
                ...
                "content": post["content"],
                "tags": post.get("tags", []),
                "cover_image": post.get("cover_image", "/assets/blog/field-tractor.jpg")
            }},
            upsert=True
        )
        count += 1
    return {"status": "seeded rich blogs", "count": count}
